...
bool CTFMechanicalArm::ShockAttack(void)
{
	...
	int count = UTIL_EntitiesInBox(pObjects, maxCollectedEntities, vecCenter - vecSize, vecCenter + vecSize, FL_GRENADE );
